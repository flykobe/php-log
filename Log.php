...
class Base_Log {
    ...
    /**
     * log路径, eg. /home/work/var/uclogin,会自动在后面加上日期
     *
     * @var string
     */
     ...
     * @var bool
     */
    protected static $_bIsDir = false;
    ...
    protected static function _getClientIp() {/*{{{*/
        ...
        $onlineip = Base_Util_Common::getClientIp();
    ...
    protected function _getReqID() {/*{{{*/
        return Base_Util_Common::getReqID();
    }/*}}}*/
